...
def import_events_challenges(directory: Path, target_directory: Path | None, *, mode: str, database: dict[str, object], writers_stopped: bool, runner=subprocess.run) -> dict[str, object]:
